        ...
        <div class="container nav__container">
            ...
            <ul class="nav__items">
                    ...
                    <?php if(isset($_SESSION['user-id'])) : ?>
                        ...
                        <ul>
                            <li><a class="fonts" href="<?= ROOT_URL ?>admin/index.php">Dashboard</a></li>
                            <li><a class="fonts" href="<?= ROOT_URL ?>logout.php">Logout</a></li>
                        </ul>
                    </li>
                    <?php else : ?> 
                    <li><a class="fonts" href="<?= ROOT_URL ?>./signin.php">შესვლა</a></li>
                    <?php endif ?>
            </ul>
